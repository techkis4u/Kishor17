...
<script type="text/javascript">
	$(window).load(function() {
		...
		if (userId == "") {
			window.location.replace("http://localhost:8989/logout.htm");
		}
	});
...
<body bgcolor="GreenYellow">
	<h1 align="center">ShipmentBooking</h1>
	<form:form modelAttribute="bookingCommand">
		<div id="error-div">
			<span style="color: red"> <form:errors path="*" /></span>
		</div>
		<div id="customer-details-div" align="center">
		...
		<div id="booking-details-div" align="center">
			<table border="1px" style="background-color: Fuchsia">
				<tr>
					<td>Vas-Prod-Cod:</td>
				...
				<tr>
					<td>Quantity:</td>
					<td><form:input path="quantity" /> <form:hidden path="userId"
							value="${userId }" /></td>
				</tr>
				<tr>
